...
/*   Updated: 2021/09/20 06:52:31 by rgallard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_loadtextures1(t_game *game)
{
	...
	game->texwall.addr = mlx_get_data_addr(game->texwall.ptr, &game->texwall.bpp,
			&game->texwall.line_len, &game->texwall.endian);
...
void	ft_loadtextures2(t_game *game)
{
	...
	game->texitem.addr = mlx_get_data_addr(game->texitem.ptr, &game->texitem.bpp,
			&game->texitem.line_len, &game->texitem.endian);
	...
	game->texexit.addr = mlx_get_data_addr(game->texexit.ptr, &game->texexit.bpp,
			&game->texexit.line_len, &game->texexit.endian);
	...
	game->texfloor.addr = mlx_get_data_addr(game->texfloor.ptr,
			&game->texfloor.bpp, &game->texfloor.line_len, &game->texfloor.endian);
}
